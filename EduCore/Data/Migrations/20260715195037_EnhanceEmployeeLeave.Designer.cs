...
namespace EduCore.Data.Migrations
{
    ...
    [Migration("20260715195037_EnhanceEmployeeLeave")]
    partial class EnhanceEmployeeLeave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduCore.Models.EmployeeLeave", b =>
                {
            ...
            modelBuilder.Entity("EduCore.Models.LeaveType", b =>
                {
                    b.Property<int>("LeaveTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduCore.Models.EmployeeLeave", b =>
                {
                    b.HasOne("EduCore.Models.Employee", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedByEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EduCore.Models.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EduCore.Models.LeaveType", "LeaveType")
